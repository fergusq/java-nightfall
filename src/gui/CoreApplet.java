...
public class CoreApplet extends Applet implements CoreApp, 
	...
	public void init() {
		...
		mBackBuffer = createImage((int)getSize().getWidth(), (int)getSize().getHeight());
		new Thread() {
		...
		addMouseListener(CoreApplet.this);
		addKeyListener(CoreApplet.this);
		addMouseMotionListener(CoreApplet.this);
		addMouseWheelListener(CoreApplet.this);
	}
